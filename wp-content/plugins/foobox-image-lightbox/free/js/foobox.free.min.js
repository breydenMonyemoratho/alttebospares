...
! function(a, b, undefined) {
    a && b && (b.FooBox = {}, FooBox.$ = a, FooBox.version = "2.4.4", FooBox.instances = [], FooBox.defaults = {
        affiliate: {
            enabled: !0,
            prefix: "Powered by ",
        ...
        return a === b.alert || "[object Function]" === Object.prototype.toString.call(a)
        ...
        }(Function("/*@cc_on return true@*/")() ? "complete" === document.readyState : "loading" !== document.readyState) ? c(): document.addEventListener("DOMContentLoaded", c, !1)
        ...
        check: function() {
            ...
            FooBox.browser.iOS = /(iPad|iPhone|iPod)/g.test(d), FooBox.browser.iOS12OrBelow = !1, FooBox.browser.iOS && (FooBox.browser.css += " fbx-ios", FooBox.browser.iOS12OrBelow = function() {
                var b = a.match(/OS (\d+)_(\d+)_?(\d+)?/i);
                return b = [parseInt(b[1], 10), parseInt(b[2], 10), parseInt(b[3] || 0, 10)], b[0] <= 12
            }(), FooBox.browser.iOS12OrBelow && (FooBox.browser.css += " fbx-ios-12-or-below")), FooBox.browser.Mac = /(Mac)/g.test(d), FooBox.browser.Mac && (FooBox.browser.css += " fbx-mac"), FooBox.browser.isChrome = a.indexOf("chrome") > -1 || a.indexOf("crios") > -1, FooBox.browser.isChrome && (FooBox.browser.css += " fbx-chrome"), FooBox.browser.isSafari = a.indexOf("safari") > -1 && !FooBox.browser.isChrome, FooBox.browser.isSafari && (FooBox.browser.css += " fbx-safari", FooBox.browser.isLtSafari10 = /constructor/i.test(b.HTMLElement)), FooBox.browser.isFirefox = c.indexOf("firefox") > -1, FooBox.browser.isFirefox && (FooBox.browser.css += " fbx-firefox");
        ...
        call: function(a, b, c, d, e) {
            var f, g = Array.prototype.slice.call(arguments);
            a = g.shift(), b = g.shift(), c = g.shift();
            for (var h = b.objects[a] || [], i = 0; i < h.length; i++) try {
        ...
        _ns: "addons",
        validate: function(a) {
            return !!FooBox.isFn(a) || (console.error(FooBox.format('Expected type "function", received type "{0}".', typeof a)), !1)
        },
        register: function(a, b) {
            return FooBox.addons.validate(a) ? FooBox.objects.register(FooBox.addons._ns, a, b) : (console.error("Failed to register the addon."), !1)
        },
        load: function(a) {
        ...
        _ns: "handlers",
        validate: function(a) {
            if (!FooBox.isFn(a)) return console.error(FooBox.format('Expected type "function", received type "{0}".', typeof a)), !1;
            var b = new a;
            return FooBox.isFn(b.handles) ? FooBox.isFn(b.defaults) ? FooBox.isFn(b.parse) ? FooBox.isFn(b.load) ? FooBox.isFn(b.getSize) ? FooBox.isFn(b.hasChanged) ? !!FooBox.isFn(b.preload) || (console.error('The required "preload" method is not implemented.'), !1) : (console.error('The required "hasChanged" method is not implemented.'), !1) : (console.error('The required "getSize" method is not implemented.'), !1) : (console.error('The required "load" method is not implemented.'), !1) : (console.error('The required "parse" method is not implemented.'), !1) : (console.error('The required "defaults" method is not implemented.'), !1) : (console.error('The required "handles" method is not implemented.'), !1)
        },
        register: function(a, b) {
            return FooBox.handlers.validate(a) ? FooBox.objects.register(FooBox.handlers._ns, a, b) : (console.error("Failed to register the handler."), !1)
        },
        load: function(a) {
        ...
        return b = b || {}, this.each(function() {
            ...
            if (d instanceof FooBox.Instance)
                if (d.options.alwaysInit === !0 || e) {
                    var g = d.options;
                    g.alwaysInit = !0, d.destroy(), d = new FooBox.Instance(d.id), d.init(this, a.extend(!0, g, f))
                } else d.reinit(f);
            else {
        ...
        } else "number" == typeof b ? c = b : (c = parseInt(b || 0), c = isNaN(c) ? 0 : c), c = c > FooBox.instances.length - 1 ? FooBox.instances.length - 1 : c < 0 ? 0 : c, d = FooBox.instances[c];
...
function(a, b) {
    b.Icons = function() {
        return this.className = "fbx-icon", this.registered = {
            ...
            return "string" == typeof b && this.registered.hasOwnProperty(b) && a.extend(!0, d, this.registered[b]), "object" == typeof b && (c = "custom", a.extend(!0, d, this.registered["default"], b)), {
                name: c,
                icons: d
            }
...
function(a, b) {
    b.Instance = function(c) {
        this.id = null, "number" == typeof c ? (this.id = c, b.instances[c - 1] = this) : this.id = b.instances.push(this), this.element = null, this.options = a.extend(!0, {}, b.defaults), this.modal = new b.Modal(this), this.objects = {}, b.addons.load(this), b.handlers.load(this);
        var d = this;
        return this.raise = function(a, c) {
            return b.raise(d, a, c)
        }, this.init = function(c, e) {
            d.element = b.isjQuery(c) ? c : a(c), d.options = b.options.merge(d.options, e || {}), b.addons.call(d, "preinit", d.element, d.options), d.items.init(), d.items.array.length > 0 ? (d.element.data("fbx_instance", d), d.options.containerCssClass && d.element.addClass(d.options.containerCssClass), d.setup.bind(), d.modal.init(c, d.options), b.handlers.call(d, "init", d.element, d.options), d.raise("foobox.initialized"), b.isFn(d.options.initCallback) && d.options.initCallback.call(d)) : d.destroy()
        }, this.reinit = function(a) {
            d.options = b.options.merge(d.options, a || {}), d.items.init(!0), d.items.array.length > 0 ? (d.setup.bind(), d.modal.reinit(d.options), b.handlers.call(d, "reinit", d.options), d.raise("foobox.reinitialized")) : d.destroy()
        }, this.destroy = function() {
            b.addons.call(d, "destroy"), b.handlers.call(d, "destroy"), d.items.destroy(), d.modal.destroy(), d.element.removeClass("fbx-instance fbx-item").data({
                fbx_instance: null,
                fbx_p_instance: null
            }), d.id == b.instances.length ? b.instances.splice(d.id - 1, 1) : b.instances[d.id - 1] = null, d.raise("foobox.destroy")
        }, this.setup = {
            bind: function() {
                a(d.options.externalSelector).off("click.fooboxExternal").on("click.fooboxExternal", function(c) {
                    c.preventDefault();
                    var d = a(this).data("foobox"),
                        e = a(d),
                        f = e.data("fbx_instance") || e.data("fbx_p_instance");
                    return e.length > 0 && f instanceof b.Instance && f.modal instanceof b.Modal && f.modal.show(!0), !1
                })
            }
        }, this.items = {
            array: [],
            indexes: {
                ...
                set: function(a) {
                    ...
                    a = a || 0, a = a > d.items.array.length - 1 ? 0 : a < 0 ? d.items.array.length - 1 : a;
                    var c = a - 1,
                        e = a + 1;
                    d.items.indexes.current = a, d.items.indexes.prev = c < 0 ? d.items.array.length - 1 : c, d.items.indexes.next = e > d.items.array.length - 1 ? 0 : e, d.items.indexes.direction = d.items.indexes._direction(b, a, d.items.array.length - 1)
                },
                _direction: function(a, b, c) {
                    return 0 == b && a == c ? ">" : b == c && 0 == a ? "<" : b > a ? ">" : b < a ? "<" : "*"
                }
            },
            new_array: function(c) {
                c = c || !1;
                var e, f, g, h = 0;
                if (1 == c) {
                    if (d.items.array.length > 0) {
                        for (var i = 0; i < d.items.array.length; i++) e = d.items.array[i], b.isjQuery(e.element) ? 0 == e.element.parents(":first").length && (d.items.array.splice(i, 1), i -= 1) : e.option || (d.items.array.splice(i, 1), i -= 1);
                        for (var j = 0; j < d.items.array.length; j++) e = d.items.array[j], b.isjQuery(e.element) ? (g = e.element.get(0), g.index = e.index = j) : e.index = j
                    }
                } else d.items.array = [];
                if (a.isArray(d.options.items))
                    for (var k = 0; k < d.options.items.length; k++)
                        if (e = d.options.items[k], d.items.indexOf(e) == -1)
                            for (var l = 0; l < d.objects.handlers.length; l++)
                                if (d.objects.handlers[l].type == e.type) {
                                    e.index = h, e.option = !0, e.handler = d.objects.handlers[l], e.handler.defaults(e), f = d.raise("foobox.parseItem", {
                                        element: null,
                                        item: e
                                    }), d.items.array.push(f.fb.item), h++;
                                    break
                                }
            },
            init: function(b) {
                ...
                if (d.element.is(d.options.selector) && !d.element.is(d.options.excludes) && d.items.add(d.element)) d.element.off("click.item").on("click.item", d.items.clicked);
                else if (d.element.is(".foogallery") && (c = d.element.data("__FooGallery__")) && c.items && (e = c.items.available(f)).length > 0) {
                    var g = a.map(e, function(a) {
                        return a.$anchor ? a.$anchor.get(0) : null
                    });
                    a(g).not(d.options.excludes).off("click.item").filter(function() {
                        return d.items.add(this)
                    }).on("click.item", d.items.clicked), d.element.on("click.item", ".fbx-link", d.items.clicked)
                } else d.element.find(d.options.selector).not(d.options.excludes).off("click.item").filter(function() {
                    return d.items.add(this)
                }).on("click.item", d.items.clicked), d.element.on("click.item", ".fbx-link", d.items.clicked);
                d.items.rel()
            },
            destroy: function() {
                ...
                var a, c;
                for (c = 0; c < d.items.array.length; c++) a = d.items.array[c], b.isFn(a.destroy) && a.destroy(), b.isjQuery(a.element) && a.element.off("click.item").removeClass("fbx-link").data("fbx_p_instance", null);
                d.items.array = []
            },
            rel: function() {
                var c = d.options.rel || d.element.attr("rel") || (d.items.first(function(a) {
                    return !!b.isjQuery(a.element) && "string" == typeof a.element.attr("rel")
                }) || {
                    element: a()
                }).element.attr("rel");
                "string" == typeof c && a('[rel="' + c + '"]').not(d.options.excludes).not(d.element).off("click.item").filter(function() {
                    return d.items.add(this)
            ...
            is: {
                first: function(a) {
                    return !(!d.items.array || 0 == d.items.array.length) && d.items.array[0].index == a.index
                },
                last: function(a) {
                    return !(!d.items.array || 0 == d.items.array.length) && d.items.array[d.items.array.length - 1].index == a.index
                }
            },
            add: function(c) {
                ...
                var f = c.get(0),
                    g = d.items.indexOf(e);
                g != -1 ? (e = d.items.array[g], f.index = e.index) : f.index = e.index = d.items.array.push(e) - 1;
            ...
            get: function(c) {
                ...
                var e = null,
                    f = c.get(0).index;
                return f && f > 0 && f <= d.items.array.length - 1 && (e = d.items.array[f]), e
            },
            parse: function(c, e) {
                c = b.isjQuery(c) ? c : a(c);
                for (var f, g, h = 0; h < d.objects.handlers.length; h++)
                    if (d.objects.handlers[h].handles(c, d.element)) {
                        f = d.objects.handlers[h].parse(c), isNaN(e) || (f.index = e), g = d.raise("foobox.parseItem", {
                            element: c,
                            item: f
                        });
                        break
            ...
            error: function(c) {
                function e(a) {
                    var c = this;
                    return c.FooBox = a, c.type = "error", c.handles = function() {
                        return !1
                    }, c.hasChanged = function() {
                        return !1
                    }, c.defaults = function() {}, c.parse = function() {}, c.load = function(a, d, e, f) {
                        try {
                ...
                if (d.items.array.length > c && 1 == d.items.array[c].error) return d.items.array[c];
                var f, g, h = b.handlers.get(d, "html"),
                    i = !1;
                return null == h && (h = new e(d)), null !== d.options.error.match(/^#/i) && a(d.options.error).length > 0 ? (f = a(d.options.error), i = !0) : f = a('<div class="fbx-error-msg" data-width="240" data-height="240"></div>').append(b.icons.get("error")).append(a("<p/>").text(d.options.error)), g = new b.Item(h.type, f.get(0), h), g.selector = 1 == i ? d.options.error : null, g.index = c, g.error = !0, g.title = f.data("title") || null, g.description = f.data("description") || null, g.width = f.data("width") || 240 || null, g.height = f.data("height") || 240 || null, g.content = 1 == i ? null : f, g.fullscreen = !0, g.handler = h, d.items.array[c] = g, g
            },
            first: function(a) {
            ...
            clicked: function(a) {
                return a.preventDefault(), d.items.indexes.set(this.index), d.modal.show(!0), !1
            }
        }, this
    }
}(jQuery, window.FooBox),
function(a, b) {
    b.Modal = function(c) {
        this.FooBox = c, this.element = null, this.loaderTimeout = new b.Timer, this._first = !1, this._busy = !1, this._closed = !1;
        var d = this;
        return this.init = function(a, b) {
            ...
            function c(a) {
                if (d.loaderTimeout.stop(), d.element.removeClass("fbx-loading"), d._busy = !1, console.error(a), !d.FooBox.raise("foobox.onError", {
                        error: a
                    }).isDefaultPrevented()) {
            ...
            if (e) {
                if (b = b || !1, d._first = b, d._busy = !0, d._closed = !1, a("body").addClass("fbx-active"), d.FooBox.options.hideScrollbars && a("html").addClass("fbx-no-scroll"), 1 == e.error ? d.element.addClass("fbx-error") : d.element.removeClass("fbx-error"), !d.element.hasClass("fbx-show")) {
                    d.prioritize();
                    var f = d.getMaxSize();
                ...
                if (h.css({
                        opacity: 0,
                        visibility: "hidden"
                    }), d.element.find(".fbx-count").text(d.FooBox.options.countMessage.replace("%index", "" + (d.FooBox.items.indexes.current + 1)).replace("%total", "" + d.FooBox.items.array.length)), d.FooBox.raise("foobox.beforeLoad", {
                        item: e
                    }).isDefaultPrevented()) return void(d._busy = !1);
                ...
                d.preload(), d.loaderTimeout.start(function() {
                    d.element.addClass("fbx-loading")
                }, d.FooBox.options.loaderTimeout), setTimeout(function() {
                    d.checkForLoop(e), e.handler.load(e, h, function(a) {
                        return 1 == d._closed ? void(d._busy = !1) : void d.transitionOut(g, function() {
                            return g.find("video").each(function() {
                                this.pause(), this.removeAttribute("src"), this.load()
                            }), 1 == d._closed ? void(d._busy = !1) : void d.resize(a, h, function() {
                                return 1 == d._closed ? void(d._busy = !1) : (d.loaderTimeout.stop(), h.css({
                                    opacity: "",
                                    visibility: ""
                                }), void d.transitionIn(h, function() {
                                    return 1 == d._closed ? void(d._busy = !1) : (h.add(g).toggleClass("fbx-item-next fbx-item-current"), g.empty(), void(d.element.hasClass("fbx-show") ? (d.element.removeClass("fbx-loading"), d.FooBox.raise("foobox.afterLoad", {
                                        item: e
                                    }), d.triggerFooGalleryLayout(h), d._busy = !1) : d.FooBox.raise("foobox.beforeShow", {
                                        item: e
                                    }).isDefaultPrevented() || (d.element.removeClass("fbx-loading").addClass("fbx-show"), d.FooBox.raise("foobox.afterShow", {
                                        item: e
                                    }), d.FooBox.raise("foobox.afterLoad", {
                                        item: e
                                    }), d.triggerFooGalleryLayout(h), d._busy = !1)))
                                }, c))
                            }, c)
                        }, c)
                    }, c)
            ...
            window.FooGallery && b.find(".foogallery").each(function() {
                var b = a(this).data("__FooGallery__");
                b && b.initialized && b.layout()
            })
        }, this.checkForLoop = function(a) {
            1 != d.FooBox.options.loop && (d.element.find(".fbx-prev, .fbx-next").removeClass("fbx-disabled"), d.FooBox.items.is.first(a) && d.element.find(".fbx-prev").addClass("fbx-disabled"), d.FooBox.items.is.last(a) && d.element.find(".fbx-next").addClass("fbx-disabled"))
            ...
            return p.marginTop = -(p.height / 2 + m + (j + i) / 2 + f / 2 - e / 2), p.marginLeft = -(p.width / 2 + m + (l + k) / 2 + h / 2 - g / 2), p
        }, this.resize = function(a, c, e, f) {
            try {
                if (0 === a.width || 0 === a.height) return void(b.isFn(f) && f("Invalid size supplied. Width = " + a.width + ", Height = " + a.height));
                var g = d.FooBox.items.current(),
                    ...
                    x = w.width / a.width;
                a.height * x > w.height && (x = w.height / a.height), d.FooBox.options.fitToScreen === !0 || 1 == g.proportion && (a.height > w.height || a.width > w.width) ? (a.height = Math.floor(a.height * x), a.width = Math.floor(a.width * x)) : 0 == g.proportion && (a.height > w.height && (a.height = w.height), a.width > w.width && (a.width = w.width)), a.height < 100 && (a.height = 100), a.width < 100 && (a.width = 100);
                var y = -(a.height / 2 + s + (p + o) / 2 + l / 2 - k / 2),
                    z = -(a.width / 2 + s + (r + q) / 2 + n / 2 - m / 2);
                if (v.equalTo(a)) i.css({
                    height: a.height,
                    width: a.width,
                    "margin-top": y,
                    "margin-left": z
                }), d.overflow(g, h, a, c), d.FooBox.raise("foobox.afterResize", {
                    item: g,
                    size: a
                }), b.isFn(e) && e();
                else if (!d.FooBox.raise("foobox.beforeResize", {
                        item: g,
                        size: a,
                        offset: {
                            top: y,
                    ...
                    if (y = -(a.height / 2 + s + (p + o) / 2 + l / 2 - k / 2), z = -(a.width / 2 + s + (r + q) / 2 + n / 2 - m / 2), d.element.hasClass("fbx-show"))
                        if (b.browser.supportsTransitions()) {
                            ...
                            "margin-top": y,
                            "margin-left": z
                        }, d.FooBox.options.resizeSpeed, function() {
                            d.overflow(g, h, a, c), d.FooBox.raise("foobox.afterResize", {
                                item: g,
                                size: a
                            }), b.isFn(e) && e(a)
            ...
            a.overflow && (c.width < .8 * b.width || c.height < .8 * b.height) || a.overflow && !a.proportion && (c.width < b.width || c.height < b.height) || a.overflow && "html" === a.type ? ("html" === a.type ? (f.css({
            ...
            })), d.FooBox.raise("foobox.showOverflow", {
                item: a,
                container: e
            })) : (f.css({
                width: "",
                ...
                "overflow-y": "",
                overflow: "hidden"
            }), d.FooBox.raise("foobox.hideOverflow", {
                item: a,
                container: e
            }))
            ...
            try {
                ...
                a.animate({
                    opacity: 0
                }, a.is(":visible") ? d.FooBox.options.transitionOutSpeed : 0, function() {
                    b.isFn(c) && c()
                })
            } catch (f) {
                b.isFn(e) && e(f)
            ...
            try {
                if (!d.element.hasClass("fbx-show")) return a.css({
                    opacity: 1
                }), void(b.isFn(c) && c());
                a.animate({
                    opacity: 1
                }, d.FooBox.options.transitionInSpeed, function() {
                    b.isFn(c) && c()
                })
            } catch (f) {
                b.isFn(e) && e(f)
            ...
            d.FooBox.raise("foobox.beforeClose").isDefaultPrevented() || (d._closed = !0, d._busy = !1, d.element.removeClass("fbx-loading fbx-show"), a("body").removeClass("fbx-active"), d.FooBox.raise("foobox.close"), d.element.find(".fbx-item-current video, .fbx-item-next video").each(function() {
                this.pause(), this.removeAttribute("src"), this.load()
            }), d.element.find(".fbx-item-current, .fbx-item-next").empty(), a("html").removeClass("fbx-no-scroll"), d.FooBox.raise("foobox.afterClose"))
        }, this.prev = function(a) {
            if (1 != d._busy) {
                if (d.FooBox.items.indexes.set(d.FooBox.items.indexes.prev), "string" == typeof a)
            ...
            if (1 != d._busy) {
                if (d.FooBox.items.indexes.set(d.FooBox.items.indexes.next), "string" == typeof a)
        ...
        this.handles = function(a) {
            ...
            try {
                var h = function() {
                    ...
                    d.FooBox.options.images.noRightClick && g.on("contextmenu", function(a) {
                        return a.preventDefault(), !1
                    }), e.empty().append(g), b.isFn(f) && f(d.getSize(c))
                };
                c.image && null !== c.image ? h() : (c.image = new Image, c.image.onload = function() {
                    c.image.onload = c.image.onerror = null, c.width && c.height || (c.height = c.image.height, c.width = c.image.width), h()
                }, c.image.onerror = function() {
                    c.image.onload = c.image.onerror = null, c.image = null, b.isFn(g) && g("An error occurred attempting to load the image.")
                }, c.image.src = c.url)
            } catch (i) {
                b.isFn(g) && g(i)
            }
...
function(a, b) {
    ...
    b.BPInfo = function(b) {
        var c = a(window);
        this.width = c.width(), this.height = c.height(), this.orientation = this.width > this.height ? "fbx-landscape" : "fbx-portrait";
        var d, e = null;
        if (a.isArray(b))
            for (var f = 0; f < b.length; f++)
                if (d = b[f], d && d.width && this.width <= d.width) {
                    e = d;
                    break
                }
        ...
        this.preinit = function(a) {
            ...
            initialized: function() {
                d.handlers.unbind(), d.setup.breakpoints(), d.style(), a(window).on("resize.foobox", d.handlers.resize), b.browser.iOS12OrBelow && (b.browser.isSafari || b.browser.isChrome) && d.FooBox.element.on({
                    "foobox.beforeShow": d.handlers.iosBeforeShow,
                    "foobox.close": d.handlers.iosClose
                })
            },
            ...
            ios: function() {
                ...
                b.browser.isChrome ? (g = i - (f ? 76 : 56), h = i - (f ? 0 : 20)) : b.browser.isSafari && (g = i - 88, h = i - (f ? 0 : 19)), (null == e || e === !1) && c <= g ? (e = !0, d.iosRedraw()) : (null == e || e === !0) && c >= h && (e = !1, d.iosRedraw()), d.timers.ios.start(d.handlers.ios, d.FooBox.options.iosInterval)
            }
        }, this.setup = {
        ...
        if (b.length > 0 && "string" == typeof c) {
            for (var d = c.split(","), e = !1, f = !1, g = 0; g < d.length; g++) {
                var h = a.trim(d[g]);
                "width" == h.substring(0, 5) && h.indexOf("device-width") !== -1 ? e = !0 : "initial-scale" == h.substring(0, 13) && (f = !0)
            }
    ...
    b.Item.prototype.captions = !1, b.Item.prototype.title = null, b.Item.prototype.description = null, b.Item.prototype.caption = null, b.Captions = function(c) {
        ...
        this.preinit = function(a) {
            ...
            setupHtml: function(b) {
                ...
                "string" == typeof b.fb.options.modalClass && b.fb.options.modalClass.indexOf("fbx-sticky-caption") != -1 ? b.fb.modal.append(c, e) : (b.fb.modal.find(".fbx-stage").append(c), b.fb.modal.find(".fbx-inner").append(e))
            },
            ...
            parseItem: function(b) {
                ...
                if (b.fb.item.captions && 0 != c.enabled) {
                    ...
                    if (null != b.fb.element) {
                        ...
                        "none" != h && (e = b.fb.element.data("captionTitle") || b.fb.element.data("title") || d.text(b.fb.element, h)), "none" != i && (f = b.fb.element.data("captionDesc") || b.fb.element.data("description") || d.text(b.fb.element, i))
            ...
            e.html(c.caption).find('a[href^="#"]').filter(function() {
                ...
                return d.length > 0 && e instanceof b.Instance && (a(this).data("hrefTarget", d.get(0)), !0)
            ...
            return "string" != typeof a ? null : (a = a.replace(/\s*-\d+/g, "").replace(/\s*_\d+/g, "").replace(/-/g, " ").replace(/_/g, " "), a = a.replace(/\w\S*/g, function(a) {
                return a.indexOf("#") != -1 ? a : a.charAt(0).toUpperCase() + a.substr(1).toLowerCase()
            }))
        }
            ...
            onCreateCaption: function(c) {
                ...
                if (1 == d.wordpress.enabled && b.isjQuery(f)) {
                    ...
                    var l = a("<div/>"),
                        m = l.html(h).text(),
                        n = l.html(i).text();
                    a.trim(h) !== a.trim(i) && m !== n || (i = null), g = "string" == typeof h && h.length > 0 ? '<div class="fbx-caption-title">' + h + "</div>" : g, g = "string" == typeof i && i.length > 0 ? g + '<div class="fbx-caption-desc">' + i + "</div>" : g, c.fb.item.title = h, c.fb.item.description = i, c.fb.item.caption = g
                }
            }
        }
...
function(a, b, c) {
    ...
    if (c.o && c.customOptions && a.extend(!0, c.o, c.customOptions), c.init = function() {
            if (a(".fbx-link").removeClass("fbx-link"), FooBox.isFn(c.pre)) try {
                c.pre(a)
            } catch (b) {
                console.error(b)
            }
            if (c.disableOthers && (a("a.thickbox").removeClass("thickbox").unbind("click"), a("#TB_overlay, #TB_load, #TB_window").remove()), a.each(c.selectors, function(b, d) {
                    a(d).foobox(c.o)
                }), c.disableOthers && a(".fbx-link").unbind(".prettyphoto").unbind(".fb"), FooBox.isFn(c.post)) try {
                c.post(a)
            } catch (b) {
                console.error(b)
            }
            ...
            var b = a("body");
            c.init(), a(document).trigger("foobox-after-init"), b.on("post-load", c.init)
        }, c.ready ? b.ready(b.once) : a(b.once), FooBox.isFn(c.custom)) try {
        c.custom(a)
    } catch (d) {
        console.error(d)
    }
